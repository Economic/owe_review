...
\subsection*{Belman and Wolfson 2010}
\vspace{-0.7em}
...
\noindent {\bf Own-wage elasticity estimate:} -0.455 (NA)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Unweighted median wage and employment elasticities of 16 industries that had significant wage effects, as calculated by authors on page 16, second paragraph from the bottom of the page.
