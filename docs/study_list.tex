...
\noindent {\bf Source of estimate:} Own-wage elasticity reported in Table 3, panel A (Employed during year), specification 3. Authors use specification 3 in Figure 6.
...
\noindent {\bf Source of estimate:} Own-wage elasticity reported in Table 4, column 6. Standard error calculated using our usual approximation, dividing Table 4 employment effect by Table 1, All stores FTE mean.
...
\noindent {\bf Own-wage elasticity estimate:} 0.072 (0.038)
...
\noindent {\bf Own-wage elasticity estimate:} 0.446 (NA)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Table CII: wage elasticity (col 3) of .083 and employment elasticity (col 6) of .037
...
\noindent {\bf Own-wage elasticity estimate:} 1.2 (0.383)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Table 2, Fast Food Workers, panel B
...
\noindent {\bf Own-wage elasticity estimate:} 0.003 (0.01)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Weighted average of HSOL < \$20 OWEs in Table E4 using shares in Table 2
