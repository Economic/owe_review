...
\subsection*{Bossler and Shank 2023}
\vspace{-0.7em}

\noindent Mario Bossler and Thorsten Shank. ``Wage Inequality in Germany after the Minimum Wage Introduction'', \href{https://doi.org/10.1086/720391}{Journal of Labor Economics}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.198 (0.204)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Selected specifications through communications with authors. Wage effect from Table 1, specification 1, row Bite X Year 2015. Employment effect from Table 3, specification 1.
...
\subsection*{Chen 2019}
\vspace{-0.7em}

\noindent Yuci Chen. ``What Do Establishments Do When Wages Increase? Evidence from Minimum Wages in the United States'', \href{https://www2.census.gov/ces/wp/2019/CES-WP-19-31.pdf}{Center for Economic Studies Working Paper}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.273 (0.196)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Own-wage elasticity reported in Table 5a, specification 12, "number of production workers". Author calls this the preferred estimate in text on p. 24.

\subsection*{Clemens Edwards Meer 2025}
\vspace{-0.7em}

\noindent Jeffrey Clemens, Olivia Edwards and Jonathan Meer. ``Did California's Fast Food Minimum Wage Reduce Employment?'', \href{https://www.nber.org/system/files/working_papers/w34033/w34033.pdf}{NBER Working Paper}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.342 (NA)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Wage effect of 8 percent from the conclusion text: "a roughly 8 percent increase in California's fast food sector relative to the fast food sector elsewhere in the country". This wage effect is similar to estimates in Figure 2b, a DD against other states. The employment effect of DD against other states is 2.74 percent, from Table 1, panel B, column 5, row FF.

\subsection*{Clemens and Strain 2025}
\vspace{-0.7em}

\noindent Jeffrey Clemens and Michael R. Strain. ``The Heterogeneous Effects of Large and Small Minimum Wage Changes: Evidence over the Short and Medium Run Using a Pre-Analysis Plan'', \href{https://doi.org/10.1086/736552}{Journal of Labor Economics}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.253 (NA)
...
\subsection*{Davies Park Stansbury 2025}
\vspace{-0.7em}

\noindent Michael Davies, R. Jisung Park and Anna Stansbury. ``Minimum Wages and Workplace Injuries'', \href{https://dx.doi.org/10.2139/ssrn.5062047}{Working Paper}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.859 (0.448)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Average of own-wage elasticities reported in Table A16.
...
\subsection*{Dube Reich Bhatt Sosinskiy 2024}
\vspace{-0.7em}

\noindent Arindrajit Dube, Michael Reich, Akash Bhatt and Denis Sosinskiy. ``Restaurant Employment, Minimum Wages, and Border Discontinuities'', \href{http://www.nber.org/papers/w32902}{NBER Working Paper}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.12 (0.289)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Average of weighted (panel A) and unweighted (panel B) own-wage elasticities reported in Table 3, specification 3.
...
\subsection*{Garcia-Louzao and Tarasonis 2023}
\vspace{-0.7em}

\noindent Jose Garcia-Louzao and Linas Tarasonis. ``Wage and Employment Impact of Minimum Wage: Evidence from Lithuania'', \href{https://doi.org/10.1016/j.jce.2022.12.002}{Journal of Comparative Economics}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.033 (0.052)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Authors selected specification in email. Own-wage elasticity reported in Table 3, specification 4.
...
\subsection*{Hamdi and Sovich 2025}
\vspace{-0.7em}

\noindent Naser Hamdi and David Sovich. ``The Wage and Employment Effects of California's Fast-Food Minimum Wage'', \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5197571}{Working Paper}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} 0.187 (0.145)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Own-wage elasticity reported in Table IA.7, specification 1.
...
\subsection*{Jha Kala Neumark Rodriguez-Lopez 2025}
\vspace{-0.7em}

\noindent Priyaranjan Jha, Jyotsana Kala, David Neumark and Antonio Rodriguez-Lopez. ``City Size, Monopsony, and the Employment Effects of Minimum Wages'', \href{https://www.nber.org/papers/w33862}{NBER Working Paper}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.724 (0.21)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Employment and wage elasticities averaged from Table 2, columns 3 and 4, main effects, row ln(minimum wage).
...
\subsection*{Kim Levere Magenheim 2025}
\vspace{-0.7em}

\noindent Jiyoon Kim, Michael Levere and Ellen Magenheim. ``Do minimum wage increases induce changes in work behavior for people with disabilities? Evidence from the AbilityOne program'', \href{https://doi.org/10.1016/j.labeco.2024.102663}{Labour Economics}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} 0.281 (0.848)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Employment effect from Table 3, Panel A, specification 2. Wage effect from Table 3, Panel C, specification 2, scaled by variable average wage of 10.94.
...
\noindent {\bf Source of estimate:} We use the "All areas" specification (1) in Table 2 to calculate the low pay proportion based wage effects with and without controls, and average them; we similarly calculate the average wage gap based effect. We do the same for employment effects from Table 3, calculating the average low pay proportion based employment effect and average wage gap based employment effect. Then we calculate the implied low-pay proportion based OWE (-0.66) and implied wage gap based OWE (-0.28). We report the average of these two elasticities.
...
\noindent {\bf Source of estimate:} Wage and employment effects are a group size weighted average of wage and employment effects the three lowest wage groups (up to 110% of the minimum wage). Group size shares are from the "Proportion" column in Table 1. The wage (employment) effect for each group is the sum of "Current" and "Lagged" effects in the "Wages" ("Employment") column of Table 2. The OWE is the group weighted average employment effect divided by the group weighted average wage effect.
...
\subsection*{Rao and Risch 2025}
\vspace{-0.7em}

\noindent Nirupama Rao and Max Risch. ``Who's Afraid of the Minimum Wage? Measuring the Impacts on Independent Businesses Using Matched U.S. Tax Returns'', \href{https://drive.google.com/file/d/1T1F-w9R3zekptwkMQ2yMWUw7JhMPMW9_/}{Quarterly Journal of Economics}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} -0.245 (0.13)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Own-wage elasticity and standard error reported on p. 15.
...
\noindent {\bf Source of estimate:} The wage and employment elasticities are the estimates in italics in Tables 2 and 3 under the "Diff-in-diff" column 5 for 16-to-29 year olds without high school degrees. The standard errors are the standard errors of the semi-elasticity multiplied by the ratio of the elasticity and semi-elasticity.
...
\noindent {\bf Source of estimate:} The wage effect is from Table 6, column 1, row 1. The employment effect is from Table 5, column 1, row 1.
...
\noindent {\bf Source of estimate:} Restaurant wage and employment elasticities are the IFE specifications in Tables 9 and Table 3.
...
\noindent {\bf Own-wage elasticity estimate:} 0.448 (0.282)

\vspace{0.7em}

\noindent {\bf Source of estimate:} Elasticities from row "Second stage (elasticity)" of Table A.2 using the year X Census division specification because that is used in the simulations. Wage elasticity from column 3 and employment elasticity from column 6.

\subsection*{Wiltshire McPherson Reich Sosinskiy 2025}
\vspace{-0.7em}

\noindent Justin C. Wiltshire, Carl McPherson, Michael Reich and Denis Sosinskiy. ``Minimum Wage Effects and Monopsony Explanations'', \href{https://doi.org/10.1086/735551}{Journal of Labor Economics}.

\vspace{0.7em}

\noindent {\bf Own-wage elasticity estimate:} 1.34 (0.459)
...
\noindent {\bf Source of estimate:} Wage elasticity from Table 5, panel A, column 5. Employment elasticity from Table 2, panel B, column 1.
...
\noindent Jesse Wursten and Michael Reich. ``Small Businesses and the Minimum Wage'', \href{https://irle.berkeley.edu/wp-content/uploads/2023/03/Small-Businesses-and-the-Minimum-Wage-3-14-23.pdf}{IRLE Working Paper}.
